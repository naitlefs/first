...
let reviewsSorted = [];
let priceSorted = [];
Object.assign(reviewsSorted, data);
Object.assign(priceSorted, data);

console.log(data);
console.log(reviewsSorted.sort((a, b) => parseInt(a.ratingRevievs) - parseInt(b.ratingRevievs)))
console.log(
    priceSorted.sort(
        (a, b) =>
            parseInt((a.price.hasOwnProperty('newUan') ? a.price.newUan : a.price).replace(' ', '')) - parseInt((b.price.hasOwnProperty('newUan') ? b.price.newUan : b.price).replace(' ', ''))
    )
)